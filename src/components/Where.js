...
import where1 from '../assets/images/location.jpeg'
import venueLogo from '../assets/images/image.png'

function Where () {
  const [isHovering, setIsHovering] = useState(false);

  const handleLocationClick = () => {
    window.open('https://maps.app.goo.gl/cSxUCvA9a6K48KCM6', '_blank');
  };
            ...
            >
              ...
              <div className='location-map-wrapper' onClick={handleLocationClick}>
                <div className='map-frame'>
                  <img src={where1} alt='Wedding Venue Location' className='location-map' />
                ...
                <div className={`map-overlay ${isHovering ? 'active' : ''}`}>
                  ...
                  <span className='click-hint'>Click to open in Google Maps</span>
                </div>
              </div>
              ...
              <div className='location-content'>
                <div className='venue-logo-wrapper'>
                  <div className='logo-circle'>
                    <img src={venueLogo} alt='Venue Logo' className='venue-logo' />
                  </div>
                  <div className='logo-glow'></div>
                </div>

                <h3 className='venue-name'>Sri Udaya Selvi Palace A/C</h3>
                ...
                <div className='address-section'>
                  ...
                  <p className='venue-address'>
                    No 11/199, Pasumai illam, street, Kalaignar St, Sushila Nagar, Kovilambakkam, Chennai, Tamil Nadu 600129
                  </p>
                </div>
